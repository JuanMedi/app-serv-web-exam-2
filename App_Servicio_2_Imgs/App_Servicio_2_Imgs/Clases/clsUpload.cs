        ...
        private string ProcesarArchivos(List<string> Archivos)
        {
            switch (Proceso.ToUpper())
            {
                case "INFRACCION":
                    ...
                    FotoInfraccion.idFotoMulta = Datos;//Debe venir la información que se procesa en la base de datos, para nuestro caso, el código del producto
                    FotoInfraccion.Archivos = Archivos;
                    return FotoInfraccion.GuardarImagenes();
                default:
